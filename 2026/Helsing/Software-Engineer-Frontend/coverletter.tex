...
\hypersetup{
  ...
  pdfkeywords={React, TypeScript, component library, frontend standards, Vite, REST, GraphQL, Rust, performance, Helsing}
}
...
I am comfortable going into \textbf{unfamiliar backends} to unblock myself: I have shipped Go, Python, Node.js and C++ (including a WebAssembly codebase), and I work with \textbf{REST and GraphQL} contracts daily. I have not written production \textbf{Rust} --- I would like to learn it, and your posting says that is fine, so I will simply be straightforward about it.
